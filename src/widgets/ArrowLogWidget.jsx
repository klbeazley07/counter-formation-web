  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
        <div>
          <span style={{ ...barlow, fontSize: "10px", letterSpacing: ".2em", textTransform: "uppercase", color: "var(--cf-gold)", fontWeight: 700 }}>
            {verse.reference}
          </span>
          <span style={{ ...barlow, fontSize: "9px", letterSpacing: ".15em", textTransform: "uppercase", color: "var(--cf-ivory-35)", marginLeft: "10px" }}>
            {verse.translation}
          </span>
        </div>
        <button onClick={onClose} aria-label="Close"
          style={{ background: "none", border: "none", padding: 0, cursor: "pointer", color: "var(--cf-ivory-18)", lineHeight: 1, marginLeft: "8px", flexShrink: 0 }}
        >
          <X size={14} />
        </button>
      </div>
      <p style={{ ...garamond, fontStyle: "italic", fontSize: "15px", color: "var(--cf-ivory)", lineHeight: 1.75, margin: "0 0 16px" }}>
        "{verse.text}"
      </p>
      <div style={{ borderTop: `1px solid rgba(255,255,255,0.06)`, paddingTop: "12px" }}>
        <a href={verse.bibleUrl} target="_blank" rel="noopener noreferrer"
          style={{ display: "flex", alignItems: "center", gap: "6px", ...barlow, fontSize: "9px", letterSpacing: ".2em", textTransform: "uppercase", color: "var(--cf-gold)", fontWeight: 700, textDecoration: "none" }}
        >
    ...
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          background: isOpen ? "var(--cf-gold-faint)" : "rgba(201,168,76,0.07)",
          border: `1px solid ${isOpen ? "var(--cf-gold-soft)" : "rgba(201,168,76,0.18)"}`,
          color: isOpen ? "var(--cf-gold)" : "var(--cf-gold-muted)",
...
function CompactEntryRow({ entry, onDelete, last }) {
  ...
  return (
    <div
      ...
      style={{ padding: "12px 0", borderBottom: last ? "none" : `1px solid var(--cf-gold-10)` }}
    >
      <div style={{ display: "grid", gridTemplateColumns: "1fr 20px", gap: "8px", alignItems: "start" }}>
        <div>
          ...
          <p style={{ ...garamond, fontSize: "14px", color: "var(--cf-ivory-35)", lineHeight: 1.55, fontStyle: "italic", margin: "0 0 10px" }}>{entry.lie}</p>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
              {entry.verses.map((v, i) => (
                <a key={i} href={v.bibleUrl} target="_blank" rel="noopener noreferrer"
                  style={{ ...barlow, fontSize: "9px", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--cf-gold-muted)", textDecoration: "none", borderBottom: `1px solid var(--cf-gold-10)`, paddingBottom: "1px" }}
                  onMouseEnter={e => { e.currentTarget.style.color = "var(--cf-gold)"; }}
                  onMouseLeave={e => { e.currentTarget.style.color = "var(--cf-gold-muted)"; }}
                >
                  {v.reference}
                </a>
              ))}
        ...
        <button onClick={() => onDelete(entry.id)} aria-label="Remove entry"
          style={{ background: "none", border: "none", padding: 0, cursor: "pointer", color: "var(--cf-ivory-18)", opacity: hovered ? 1 : 0, transition: "opacity .15s, color .15s", lineHeight: 1, marginTop: "2px" }}
          onMouseEnter={e => { e.currentTarget.style.color = "rgba(220,80,80,0.8)"; }}
          onMouseLeave={e => { e.currentTarget.style.color = "var(--cf-ivory-18)"; }}
        >
          <Trash2 size={14} />
        </button>
      </div>
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <p style={{ ...barlow, fontSize: "9px", letterSpacing: ".5em", textTransform: "uppercase", color: "var(--cf-gold)", marginBottom: "3px" }}>
              Arrow Log
            </p>
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "14px", paddingTop: "16px", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
                    <button
                      ...
                      style={{ ...barlow, background: "none", border: "none", cursor: "pointer", fontSize: "9px", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--cf-ivory-35)", padding: 0, transition: "color .15s" }}
                    >
                      Discard
                    </button>
                    <button
                      ...
                      style={{
                        ...
                        background: "var(--cf-gold)", color: "#0A0A0A", border: "none",
      ...
      >
        ...
        <div style={{ padding: "1.25rem 1.5rem 1rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "10px" }}>
            <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "rgba(220,60,60,0.45)", flexShrink: 0 }} />
          ...
          <textarea
            ...
            style={{
              ...garamond,
              width: "100%", background: "var(--cf-rule-bg)",
              border: `1px solid var(--cf-gold-faint)`, borderRadius: "10px",
              padding: "10px 12px", color: "var(--cf-ivory)",
            ...
            onBlur={e  => { e.target.style.borderColor = "var(--cf-gold-faint)"; }}
          />
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "10px" }}>
            <p style={{ ...barlow, fontSize: "9px", color: "var(--cf-ivory-18)", letterSpacing: ".1em", margin: 0 }}>
        ...
        {(isGenerating || currentTruth) && (
          <div style={{ padding: "0 1.5rem 1.25rem" }}>
            <div style={{ height: "1px", background: "var(--cf-gold-10)", marginBottom: "1.25rem" }} />
            ...
            {isGenerating ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", padding: "16px 0" }}>
                <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  ...
                  <Sparkles size={12} style={{ position: "absolute", color: "var(--cf-gold)" }} />
                </div>
                <p className="al-pulse" style={{ ...barlow, fontSize: "9px", letterSpacing: ".3em", textTransform: "uppercase", color: "var(--cf-gold-muted)", margin: 0 }}>
                  Consulting Scripture
                </p>
              </div>
            ) : currentTruth ? (
              <div className="al-fade-in">
                <p style={{ ...garamond, fontSize: "16px", color: "var(--cf-ivory)", lineHeight: 1.7, fontStyle: "italic", marginBottom: "14px" }}>
                  {currentTruth.truth}
                </p>
                {currentTruth.verses && currentTruth.verses.length > 0 && (
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "12px", paddingTop: "12px", borderTop: `1px solid rgba(255,255,255,0.06)` }}>
                  <Button
                    variant="ghost"
                    size="sm"
        ...
        {!isGenerating && !currentTruth && !error && (
          <div style={{ padding: "0 1.5rem 1.25rem", display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <p style={{ ...garamond, fontStyle: "italic", fontSize: "14px", color: "var(--cf-ivory-18)", lineHeight: 1.5, margin: 0 }}>
              The truth will be revealed here...
            </p>
          </div>
        )}
        ...
        <div style={{ padding: "0 1.5rem 1rem", textAlign: "center" }}>
          <Link to="/rule-of-life/community"
            style={{ ...barlow, fontSize: "9px", letterSpacing: ".32em", textTransform: "uppercase", color: "var(--cf-gold)", opacity: 0.5, textDecoration: "none" }}
          >
            Part of the Community rhythm →
          </Link>
        </div>

        <div style={{ height: "1px", background: "var(--cf-gold-10)", margin: "0 1.5rem" }} />
        ...
        <button
          ...
          style={{
            ...
            color: "var(--cf-gold-muted)", transition: "color .15s", justifyContent: "center",
          }}
          onMouseEnter={e => { e.currentTarget.style.color = "var(--cf-gold)"; }}
          onMouseLeave={e => { e.currentTarget.style.color = "var(--cf-gold-muted)"; }}
        >
        ...
        {showHistory && (
          <div id="al-history-list">
            ...
            >
              {logs.length === 0 ? (
                <p style={{ ...garamond, fontStyle: "italic", fontSize: "14px", color: "var(--cf-ivory-18)", lineHeight: 1.7, textAlign: "center", margin: 0 }}>
                  No arrows logged yet. Start by identifying a lie you have been believing.
                </p>
              ) : (
                logs.map((entry, i) => (
