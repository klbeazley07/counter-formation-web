...
const TABS = [
  ...
  { key: "formation", label: "Formation",  path: "/#rule",    icon: "formation" },
  { key: "identity",  label: "Identity",   path: "/identity", icon: "identity" },
...
function getActiveTab(pathname) {
  ...
  if (pathname.startsWith("/rule-of-life")) return "formation";
...
export function MobileTabBar() {
  ...
  // Show tab bar after initial scroll (same as current MobileBottomNav)
  useEffect(() => {
  ...
  const handleTabTap = (tab) => {
    ...
    if (tab.path.includes("#")) {
      // Hash navigation — go to homepage then scroll
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              animation: "moreSheetUp 0.3s cubic-bezier(0.22, 1, 0.36, 1) forwards",
            }}
          >
            {/* Drag handle */}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(250,248,245,0.4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
