  ...
  if (!isAuthenticated && !hasMeaningfulActivity(profile)) {
    return (
      <div style={{ minHeight: "100dvh", backgroundColor: "var(--cf-hero-bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--cf-font-devotional)", fontStyle: "italic", fontSize: "clamp(16px, 3vw, 20px)", color: "var(--cf-ivory-62)", maxWidth: 480, marginBottom: "2rem", lineHeight: 1.6 }}>
  ...
  return (
    <div style={{ minHeight: "100dvh", backgroundColor: "var(--cf-hero-bg)", color: "var(--cf-ivory)" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "clamp(40px, 6vw, 80px) 24px clamp(60px, 8vw, 100px)" }}>
        ...
        <p style={{ fontFamily: "var(--cf-font-devotional)", fontStyle: "italic", fontSize: "clamp(17px, 3.2vw, 21px)", color: "var(--cf-ivory-62)", lineHeight: 1.65, marginBottom: "3rem", maxWidth: 560 }}>
        ...
        <div style={{ borderTop: `1px solid var(--cf-white-8)`, paddingTop: "2.5rem" }}>
          ...
          {result && (
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <p style={{ fontFamily: "var(--cf-font-devotional)", fontSize: "clamp(19px, 3.5vw, 23px)", lineHeight: 1.7, color: "var(--cf-ivory)" }}>
                {result.text}
              </p>
              <p style={{ fontFamily: "var(--cf-font-devotional)", fontStyle: "italic", fontSize: 15, color: "var(--cf-ivory-28)" }}>
