...
export default function AgentOnboarding() {
  ...
  if (!isAuthenticated && !hasMeaningfulActivity(profile)) {
    return (
      <div style={{ minHeight: "100dvh", backgroundColor: C.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center" }}>
        <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, letterSpacing: "0.42em", textTransform: "uppercase", color: C.gold, marginBottom: "1rem" }}>
          Formation Assessment
        </p>
        <h1 style={{ fontFamily: "'Michroma', sans-serif", fontSize: "clamp(24px, 5vw, 42px)", textTransform: "uppercase", letterSpacing: "0.08em", color: C.ivory, marginBottom: "1rem", lineHeight: 1 }}>
          Start with the Fruit
        </h1>
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "clamp(16px, 3vw, 20px)", color: C.muted, maxWidth: 480, marginBottom: "2rem", lineHeight: 1.6 }}>
        ...
        <Link
          ...
          style={{ display: "inline-block", padding: "14px 32px", borderRadius: 999, background: C.gold, color: "#0A0A0A", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.28em", textTransform: "uppercase", textDecoration: "none" }}
        >
        ...
        <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: "2.5rem" }}>
          ...
          {result && (
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, letterSpacing: "0.42em", textTransform: "uppercase", color: C.gold }}>
                Formation Framing
              </p>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(19px, 3.5vw, 23px)", lineHeight: 1.7, color: C.ivory }}>
                {result.text}
              </p>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: 15, color: C.dim }}>
